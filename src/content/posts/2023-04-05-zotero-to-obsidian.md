...
- Where has it come from Obsidian was created by a team of software engineers and designers who wanted a powerful note-taking tool for their own work. They built it using [Electron](https://www.electronjs.org), a framework for creating desktop applications using web technologies. The goal was to make a flexible app that could handle large numbers of interconnected notes, using plain text files (markdown) and folders.
...
Install the Zotero plugin and set up the folders you want to save into.
 I then use this [template](https://brianpcasey.github.io/Design_Art_Research/uploads/ZotTemp2.pdf) as the Zotero import (posted as pdf so Jykell dosent get over enthuastic and try to render it) . This produces a [nicely formatted result](https://brianpcasey.github.io/Design_Art_Research/uploads/gattoMakingResearchUseful2015.pdf)  with the highlighted text, clipped images and annotations, with links back to the right spot in the paper in the Zotero database. Magic.  Link those notes to your other thoughts and notes and you get to the beginnings of a literature review.  As with all these productivity tools the trick is to not get distracted by the tool to the extent that you forget to do some actual work .